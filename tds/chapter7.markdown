---
title: Sitecore TDS - Web Deploy files
layout: TdsLayout
---
...
Sitecore TDS can be configured to build WebDeploy packages simply by enabling WebDeploy package generation in the [WebDeploy package](./chapter4.html#webdeploy-package) tab of the Sitecore TDS property pages.
